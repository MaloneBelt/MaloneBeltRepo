...
export const pt: Dictionary = {
  ...
  about: {
    ...
    storyParagraphs: [
      ...
      "Por trás da linha há um motor de referência cruzada: modelos de máquina e números de peça OEM mapeados para especificações MB exatas — largura, comprimento, lonas, emenda e classe de cobertura. Envie qualquer um dos dois e receba a medida confirmada, não um catálogo para decifrar.",
    ...
    values: [
      {
        title: "Referência cruzada, não chute",
        body: "Todo pedido parte do modelo da sua máquina ou do número de peça OEM. Nossa central confirma dimensões, emenda e classe de cobertura contra a especificação OEM antes de qualquer envio.",
      },
      {
        title: "Especificação OEM, certificada",
        body: "As correias são fabricadas conforme DIN 22102 em um processo certificado ISO 9001, e cada número de peça MB fica registrado para que a sua próxima recompra seja um e-mail de uma linha.",
      },
      {
    ...
    oemLead:
      "Toda correia começa em uma máquina. Estes são os fabricantes cujos britadores, peneiras, lavadores e recicladoras nossa central de referência cruzada atende todos os dias.",
  },
  comingSoon: {
    metaTitle: "Em breve",
    metaDescription:
